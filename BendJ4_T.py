...
class Move_Torque:
	...
	def CaluTorque(self):
		...
		self.error = self.goal.data[3] - self.rob_state.position[3]
...
def main():
	...
	try:
		...
		path = '/home/zxl5344/catkin_ws/src/iiwa_ros/iiwa_ros/lus-rosscripts/BendJ4_T.csv'
